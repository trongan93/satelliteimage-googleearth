...
class SatelliteQueryImage:
    ...
    def getLANDSAT7ImagesContainLandslide(self, landslide_lat, landslide_lng, landslide_event_date, landslide_event_collection):
        return ee.ImageCollection(sl_config.LANDSAT_7).filterBounds(ee.Geometry.Point(landslide_lng,landslide_lat)).filterDate(landslide_event_date,landslide_event_collection).sort('CLOUDY_PIXEL_PERCENTAGE')
    def getSENTINEL2ImagesContainLandslide(self, landslide_lat, landslide_lng, landslide_event_date, landslide_event_collection):
        return ee.ImageCollection(sl_config.SENTINEL_2).filterBounds(ee.Geometry.Point(landslide_lng,landslide_lat)).filterDate(landslide_event_date,landslide_event_collection).sort('CLOUDY_PIXEL_PERCENTAGE')
    ...
    def getSatellitesImagesContainLandslide(self, landslide_lat, landslide_lng, landslide_event_date, landslide_event_collection):
        ...
        return {'landsat_8':landsat_8_images, 'landsat_7':landsat_7_images, 'sentinel_2':sentinel_2_images, 'alos_2':alos_2_images}, {'landsat_8_error' : error_landsat_8, 'landsat_7_error' : error_landsat_7, 'sentinel_2_error' : error_sentinel_2, 'alos_2_error' : error_alos_2}
